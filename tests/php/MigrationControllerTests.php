...
namespace Automattic\WooCommerce\StockNotificationsMigrator\Tests;

use Automattic\WooCommerce\StockNotificationsMigrator\MigrationController;
...
class MigrationControllerTests extends WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'woocommerce_get_batch_processor' );
