...
namespace Automattic\WooCommerce\StockNotificationsMigrator\Tests\Writers;
...
class WriterContractTests extends WC_Unit_Test_Case {
	...
	public function test_a_product_marker_write_does_not_fire_the_product_save_hooks(): void {
		...
		try {
			$written = Container::get( Writer::class )->write_product_marker( $product->get_id(), self::MARKER_KEY, '1' );
		} finally {
