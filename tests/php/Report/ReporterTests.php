...
namespace Automattic\WooCommerce\StockNotificationsMigrator\Tests\Report;
...
class ReporterTests extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		// A spy logger left behind by another test class would swallow these lines: WordPress's
		// test case restores the hooks it backed up in setUp, which undoes the spy's own removal.
	...
	public function test_no_log_line_carries_row_content(): void {
		...
		$migrator->migrate_batch( $batch, Container::get( Writer::class ) );
