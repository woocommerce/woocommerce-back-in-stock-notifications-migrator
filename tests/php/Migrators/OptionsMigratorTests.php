...
use Automattic\WooCommerce\StockNotificationsMigrator\Migrators\OptionsMigrator;
...
class OptionsMigratorTests extends WC_Unit_Test_Case {
	...
	public function test_a_value_that_already_matched_is_settled(): void {
		...
		$this->build_migrator( $state )->migrate( Container::get( Writer::class ) );
	...
	public function test_has_pending_clears_once_a_run_has_been_through_everything(): void {
		...
		$migrator->migrate( Container::get( Writer::class ) );
	...
	public function test_an_unknown_placeholder_is_reported(): void {
		...
		$counts = $this->build_migrator()->migrate( Container::get( Writer::class ) );
	...
	private function migrate(): array {
		return $this->build_migrator()->migrate( Container::get( Writer::class ) );
	}
