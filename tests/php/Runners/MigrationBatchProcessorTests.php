...
namespace Automattic\WooCommerce\StockNotificationsMigrator\Tests\Runners;
...
use Automattic\WooCommerce\StockNotificationsMigrator\Migrators\MigratorInterface;
...
use Automattic\WooCommerce\StockNotificationsMigrator\Tests\Helpers\LegacyStore;
...
class MigrationBatchProcessorTests extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		$this->processor->init( $requirements, Container::get( Writer::class ) );
	...
	public function test_a_section_that_cannot_settle_its_rows_still_terminates(): void {
		...
		$this->processor->configure_run( array( 'notifications' => $stuck ), Container::get( Writer::class ), 50 );
	...
	public function test_a_cursorless_section_that_settles_nothing_is_parked(): void {
		...
		$this->processor->configure_run( array( 'product-meta' => $stuck ), Container::get( Writer::class ), 50 );
	...
	private function new_processor(): MigrationBatchProcessor {
		...
		$processor->init( $requirements, Container::get( Writer::class ) );
